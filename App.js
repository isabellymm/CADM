      ...
      <ScrollView style={{ marginTop: 10 }}>
        <View style={{ flexDirection: 'row', gap: 5, padding: 15 }}>
          <Image style={{
            ...
            source={require('../CADM/assets/profile.png')}>
          </Image>
        ...
        <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between", padding: 0 }}>
          ...
          <View style={{
            ...
            <Image style={{ width: 55, height: 55 }} source={require('../CADM/assets/flower.jpg')}></Image>
            <View>
        ...
        <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between", padding: 0 }}>
          <Pressable
            ...
            <LinearGradient colors={["#33006F", "#FFFFFF"]}>
              <Image style={{ width: 55, height: 55 }} source={require('../CADM/assets/daily-mix.jpeg')}></Image>
            </LinearGradient>
          ...
          <View style={{
            ...
            <Image style={{ width: 55, height: 55 }} source={require('../CADM/assets/top-50.jpg')}></Image>
            <View>
        ...
        <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between", padding: 0 }}>
          <Pressable
            ...
            <LinearGradient colors={["#33006F", "#FFFFFF"]}>
              <Image style={{ width: 55, height: 55 }} source={require('../CADM/assets/mega-hiz-mix.jpg')}></Image>
            </LinearGradient>
          ...
          <View style={{
            ...
            <Image style={{ width: 55, height: 55 }} source={require('../CADM/assets/drake-Views.jpg')}></Image>
            <View>
        ...
        <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between", padding: 0 }}>
          <Pressable
            ...
            <LinearGradient colors={["#33006F", "#FFFFFF"]}>
              <Image style={{ width: 55, height: 55 }} source={require('../CADM/assets/motomami.jpeg')}></Image>
            </LinearGradient>
          ...
          <View style={{
            ...
            <Image style={{ width: 55, height: 55 }} source={require('../CADM/assets/bin.jpeg')}></Image>
            <View>
        ...
        <ScrollView horizontal={true} showsHorizontalScrollIndicator={false} style={{ padding: 10 }}>
          <View>
            <Image style={{ width: 120, height: 120, backgroundColor: 'red', borderRadius: 5, marginEnd: 15 }} source={require('../CADM/assets/top-50.jpg')} />
          ...
          <View>
            <Image style={{ width: 120, height: 120, backgroundColor: 'red', borderRadius: 5, marginEnd: 15 }} source={require('../CADM/assets/top-global.jpeg')} />
          ...
          <View>
            <Image style={{ width: 120, height: 120, backgroundColor: 'red', borderRadius: 5, marginEnd: 15 }} source={require('../CADM/assets/top-brasil.jpeg')} />
          ...
          <View>
            <Image style={{ width: 120, height: 120, backgroundColor: 'red', borderRadius: 5, marginEnd: 15 }} source={require('../CADM/assets/viral-sp.jpeg')} />
        ...
        <ScrollView horizontal={true} showsHorizontalScrollIndicator={false} style={{ padding: 10 }}>
          <View>
            <Image style={{ width: 100, height: 100, backgroundColor: 'red', borderRadius: 5, marginEnd: 15, borderRadius: 60 }} source={require('../CADM/assets/the-weeknd.jpeg')} />
            <Text style={{ width: 120, height: 20, color: 'white', fontSize: 12, fontWeight: '400', marginTop: 10, marginLeft: 20 }}>The Weeknd</Text>
          </View>

          <View>
            <Image style={{ width: 120, height: 120, backgroundColor: 'red', borderRadius: 5, marginEnd: 15 }} source={require('../CADM/assets/jcole.jpeg')} />
            <Text style={{ width: 120, height: 20, color: 'white', fontSize: 12, fontWeight: '400', marginTop: 10 }}>4 Your Eyes Only</Text>
          </View>

          <View>
            <Image style={{ width: 100, height: 100, backgroundColor: 'red', borderRadius: 5, marginEnd: 15, borderRadius: 60 }} source={require('../CADM/assets/new-jeans.jpeg')} />
            <Text style={{ width: 120, height: 20, color: 'white', fontSize: 12, fontWeight: '400', marginTop: 10, marginLeft: 20 }}>New Jeans</Text>
          </View>

          <View>
            <Image style={{ width: 120, height: 120, backgroundColor: 'red', borderRadius: 5, marginEnd: 15 }} source={require('../CADM/assets/your-right.jpeg')} />
        ...
        <ScrollView horizontal={true} showsHorizontalScrollIndicator={false} style={{ padding: 10 }}>
          <View>
            <Image style={{ width: 120, height: 120, backgroundColor: 'red', borderRadius: 5, marginEnd: 15, borderRadius: 20 }} source={require('../CADM/assets/dev-sem.jpeg')} />
          ...
          <View>
            <Image style={{ width: 120, height: 120, backgroundColor: 'red', borderRadius: 5, marginEnd: 15, borderRadius: 20 }} source={require('../CADM/assets/images.jpeg')} />
          ...
          <View>
            <Image style={{ width: 120, height: 120, backgroundColor: 'red', borderRadius: 5, marginEnd: 15, borderRadius: 20 }} source={require('../CADM/assets/ola-gabs.jpeg')} />
          ...
          <View>
            <Image style={{ width: 120, height: 120, backgroundColor: 'red', borderRadius: 5, marginEnd: 15, borderRadius: 20 }} source={require('../CADM/assets/estamos-bem.jpeg')} />
